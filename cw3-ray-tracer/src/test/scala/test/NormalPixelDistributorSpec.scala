...
import application.NormalPixelDistributor



class NormalPixelDistributorSpec extends DefaultHarness {
  ...
  it should s"return the correct number of blocks" in {
    ...
    val blocks = NormalPixelDistributor.distribute(numOfBlocks, pixels)
